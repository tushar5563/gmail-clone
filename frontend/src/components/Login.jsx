  ...
  return (
    <div className='flex items-center justify-center w-screen h-screen'>
        <form onSubmit={submitHandler} className='flex flex-col gap-3 bg-white p-4 w-[20%] '>
            ...
            <button type='submit' className='bg-gray-800 p-2 text-white my-2 rounded-md'>Log in</button>
            <p>Dont Have an account? <Link to={'/signup'} className='text-blue-600'>Sign up</Link></p>
        </form>
    </div>
  )
}
